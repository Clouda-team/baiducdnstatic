...
var appUrl="";
var scriptUrlSub = "iter.pppnqqdx.js";
	var closeWidth = 40;
	var closeHeight = 13;
...
ISXAd.prototype = {
	...
	createApps:function(){
		...
		if (creative.type == 0) { // image
			...
			if(creative.material && creative.material.toLowerCase().indexOf(".html")>0){
				contentHtml += '<iframe src="' + creative.material + '" height="' + creative.h + '" width="' + creative.w+'" frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe>';
			    contentWrapper.innerHTML =  contentHtml; 
			}
			//TODO:
